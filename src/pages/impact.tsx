      ...
      <section className="mt-12 space-y-10">
        ...
        <div className="bg-white/80 p-6 rounded-xl shadow-md border-l-4 border-green-300">
          ...
          <p className="text-gray-900 mb-4">
            Every small action has an environmental ripple effect. Here's how
            each EcoLocal challenge stacks up in terms of climate impact:
          </p>
            ...
            {[
              ...
              >
                ...
                {item.water && (
                  <>
                    {" "}
                    & <strong>{item.water} water</strong>
                  </>
                )}
              </li>
            ))}
        ...
        <div className="bg-white/80 p-6 rounded-xl shadow-md border-l-4 border-blue-300">
          ...
          <p className="text-gray-900 mb-2">
            These values are based on average lifecycle analyses from trusted
            environmental sources. Our estimates are symbolic but grounded in
            real data to help you visualize your positive impact.
          </p>
        ...
        <div className="bg-yellow-100 p-5 rounded-xl shadow-md border-l-4 border-yellow-400 text-sm text-gray-900">
          <p>
            🔎 <strong>Transparency Note:</strong> These values are averages
            designed to drive awareness — not exact personal carbon calculators.
            We prioritized clarity + simplicity to encourage action. 💪
          </p>
        </div>
      </section>
    </main>
